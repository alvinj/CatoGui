...
//import javax.swing.*;
//
//public class KSGenerateCRUDController
//{
//  // our lists
...
//  private KSGenerateCRUDController()
//  {
//  }
//
//  public KSGenerateCRUDController(Db2AppModuleController db2AppModuleController)
//  {
//    this.db2AppModuleController = db2AppModuleController;
//    crudConfigurationDialog = new CRUDConfigurationDialog((java.awt.Frame) db2AppModuleController.getMainFrame());
//    setTitle();
...
//    
//    addActionListeners();
//    populateListOfFieldsAvailable(db2AppModuleController.getCurrentlySelectedTableName());
//  }
//
...
//    String currentlySelectedTableName = db2AppModuleController.getCurrentlySelectedTableName();
//    if (currentlySelectedTableName==null || currentlySelectedTableName.trim().equals(""))
//    {
//      JOptionPane.showMessageDialog(db2AppModuleController.getMainFrame(), "Please select a table name to begin this process.");
//      return;
//    }
